...
This dialog allows you to create a new project by specifying a name, the source and target languages and the file pairs.
...
This dialog allows you to change the application language and, if there is an open project, to customize the segmentation rules [WIP].
